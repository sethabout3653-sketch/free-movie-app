...
export const STREAMING_PROVIDERS: StreamingProvider[] = [
  ...
  },
  {
    ...
    name: 'Peacock',
    badgeColor: '#00A8E1',
    logoSvg: 'https://image.tmdb.org/t/p/w500/gIAcGTjKKr0KOHL5s4O36roJ8p7.png',
    networkId: 3353,
    providerId: 386,
    invertOnDark: false,
    lightBg: true,
  ...
  },
  {
    ...
    name: 'Crunchyroll',
    badgeColor: '#F47521',
    logoSvg: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRfb44e1f672ybZXlaHUYnYBp7fcf3f8aQnk-kafJd_ig&s=10',
    networkId: 1112,
    providerId: 283,
  },
  {
